...
struct OnboradingView: View {
   //MARK: - Property
    ...
    @State private var buttonWidth: Double = UIScreen.main.bounds.width - 80//butonu sğrğklemek
    @State private var buttonOffset: CGFloat = 0 //butonu sürüklemek
